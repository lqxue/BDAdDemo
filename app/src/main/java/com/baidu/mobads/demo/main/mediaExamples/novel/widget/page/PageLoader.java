...
public abstract class PageLoader {
    ...
    public void setPageStyle(PageStyle pageStyle) {
        ...
        if (mPageChangeListener != null) {
            mPageChangeListener.onPageBgColor(pageStyle);
        }
    ...
    void prepareDisplay(int w, int h) {
        ...
        if (mPageStyle != null && mPageChangeListener != null) {
            mPageChangeListener.onPageBgColor(mPageStyle);
        }
    ...
    void pageCancel() {
        if (mCurPage.position == 0 && mCurChapterPos > mLastChapterPos) { // 加载到下一章取消了
            ...
            if (mNextPageList != null) {
                ...
                if (parseNextChapter() && mCurPageList != null) {
                    mCurPage = mCurPageList.get(0);
                } else {
                    mCurPage = new TxtPage();
                }
...
//            adPage.lines = new ArrayList<>(lines);
    ...
    public interface OnPageChangeListener {
         ...
         * @param pageStyle
         */
        void onPageBgColor(PageStyle pageStyle);
    }
