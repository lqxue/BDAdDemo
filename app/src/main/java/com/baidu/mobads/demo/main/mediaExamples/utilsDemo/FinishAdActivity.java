...
public class FinishAdActivity extends Activity {
        ...
        mBaiduNativeManager.loadFeedAd(requestParameters, new BaiduNativeManager.NativeLoadListener() {
            ...
            public void onNativeLoad(List<NativeResponse> nativeResponses) {
                ...
                if (nativeResponses != null && nativeResponses.size() > 0) {
                    ...
                    mResponse.registerViewForInteraction(mAdView, new NativeResponse.AdInteractionListener() {
                        @Override
                    ...
                    // 为广告中所有的元素都添加点击
                    addClick(mButton, mResponse);
                    addClick(mTitle, mResponse);
                    addClick(mAdIcon, mResponse);
                    addClick(mAdImage, mResponse);
                    addClick(mContent, mResponse);
                    // 为公司logo加上点击
    ...
    // 为组件添加点击
    private void addClick(View view, final NativeResponse nativeResponse) {
