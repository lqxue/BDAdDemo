...
public class NewsDemoActivity extends FragmentActivity {
    ...
    private void initData() {
        ...
        for (final String label : labels) {
            if (label.equals("大图")) {
                fragmentList.add(NewsListFragment.newInstance(context, NewsListFragment.FRAG_AD_BIG_PIC, label));
            } else if (label.equals("视频")) {
                fragmentList.add(NewsListFragment.newInstance(context, NewsListFragment.FRAG_AD_VIDEO, label));
            } else if (label.equals("三图")) {
                fragmentList.add(NewsListFragment.newInstance(context, NewsListFragment.FRAG_AD_TRI_PIC, label));
            } else {
                fragmentList.add(NewsListFragment.newInstance(context, NewsListFragment.FRAG_AD_MIXED, label));
            }
        }
