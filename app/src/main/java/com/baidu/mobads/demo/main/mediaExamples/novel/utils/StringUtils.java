...
import static com.baidu.mobads.demo.main.mediaExamples.novel.model.local.ReadSettingManager.SHARED_READ_CONVERT_TYPE;
...
public class StringUtils {
    ...
    public static String getString(@StringRes int id){
        return MobadsApplication.getContext().getResources().getString(id);
    }

    public static String getString(@StringRes int id, Object... formatArgs){
        return MobadsApplication.getContext().getResources().getString(id,formatArgs);
    }
