...
public class ScreenUtils {
    ...
    public static int getStatusBarHeight(){
        Resources resources = MobadsApplication.getContext().getResources();
    ...
    public static int getNavigationBarHeight() {
        ...
        Resources rs = MobadsApplication.getContext().getResources();
    ...
    public static DisplayMetrics getDisplayMetrics(){
        DisplayMetrics metrics = MobadsApplication
                .getContext()
                .getResources()
                .getDisplayMetrics();
        return metrics;
