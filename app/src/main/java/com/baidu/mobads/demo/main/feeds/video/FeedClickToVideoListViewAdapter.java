...
public class FeedClickToVideoListViewAdapter extends BaseAdapter implements OnClickListener {
    ...
    public FeedClickToVideoListViewAdapter(Context context, List<Object> list) {
